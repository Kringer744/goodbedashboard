import { LayoutDashboard, Users, FileText, Settings, LogOut, BarChart2, Bell } from 'lucide-react';
    ...
    return (
        <div className="w-64 h-screen bg-white border-r border-slate-200 flex flex-col p-4 fixed left-0 top-0">
            <div className="flex items-center gap-2 px-2 mb-8">
                <img src="/src/assets/gb_encurtado.png" alt="Goodbe" className="h-8" />
                <span className="text-xl font-bold text-slate-800">Goodbe</span>
            </div>
