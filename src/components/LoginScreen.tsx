...
export const LoginScreen: React.FC<LoginScreenProps> = ({ onLogin }) => {
    ...
    return (
        <div className="min-h-screen bg-[#F8F9FA] font-manrope selection:bg-accent selection:text-white flex flex-col items-center justify-center relative overflow-hidden">
            ...
            {/* Decorative Circles */}
            <div className="absolute top-[-10%] left-[-5%] w-[600px] h-[600px] rounded-full bg-[#B1D135]/5 blur-[100px]" />
            <div className="absolute bottom-[-15%] right-[-5%] w-[800px] h-[800px] rounded-full bg-[#0F3C23]/5 blur-[120px]" />
            <div className="absolute top-[20%] right-[10%] w-[400px] h-[400px] rounded-full border-[100px] border-[#B1D135]/3 opacity-50" />
            <div className="absolute top-[50%] left-[20%] w-[1200px] h-[1200px] rounded-full border-[150px] border-slate-100 opacity-30 -translate-y-1/2" />

            <div className="max-w-[1240px] w-full px-6 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center relative z-10">
                ...
                >
                    <div className="mb-12">
                        <h1 className="text-[4.5rem] font-black text-primary leading-[0.95] tracking-tighter mb-8">
                            Gestão <br />
                            <span className="text-accent underline decoration-accent/20">Corporativa</span>
                        </h1>
                        <p className="text-slate-500 text-[18px] font-semibold max-w-sm leading-relaxed">
                            Painel Interno de Gestão de Unidades, Membros e Performance Goodbe. Acesse para gerenciar o ecossistema de saúde e bem-estar.
                        </p>
                    </div>
                ...
                >
                    <div className="w-full max-w-[480px]">
                        <div className="bg-white/70 backdrop-blur-[32px] rounded-[3rem] p-12 border border-white shadow-[0_40px_80px_-20px_rgba(0,0,0,0.08)] relative overflow-hidden">
                            {/* Top Accent Bar */}
                            <div className="absolute top-0 left-0 w-full h-2 bg-gradient-to-r from-primary via-accent to-primary" />

                            <div className="flex justify-center mb-12">
                                <img
                                    src={goodbeLogotipoNeg}
                                    alt="Goodbe Admin"
            ...
            {/* Footer Scripts */}
            <footer className="absolute bottom-10 w-full text-center text-[11px] font-black text-slate-400 uppercase tracking-[0.3em] px-6">
                © 2024 Goodbe Health & Wellness  •  Gestão Interna
            </footer>
        </div>
    );
};
