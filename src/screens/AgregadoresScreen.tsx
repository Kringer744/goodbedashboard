  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
        {[
          { label: 'Membros via Agregadores', value: totalAtivos.toLocaleString('pt-BR'), icon: Users,      color: 'text-primary', bg: 'bg-[#E8F5EC]' },
          { label: 'Receita Mensal Parceiros', value: `R$ ${totalReceita.toLocaleString('pt-BR')}`, icon: DollarSign, color: 'text-accent',  bg: 'bg-[#F0F7EC]' },
      ...
      >
        <div className="bg-[#F9FBF9] px-8 py-5 grid grid-cols-[2fr_1.5fr_1.2fr_1fr_1fr_1fr_auto] gap-4 border-b border-slate-100">
            ...
            {filtered.map((item, idx) => {
              ...
              return (
                <motion.div
                  ...
                  className="px-8 py-5 grid grid-cols-[2fr_1.5fr_1.2fr_1fr_1fr_1fr_auto] gap-4 items-center hover:bg-[#FAFCFA] transition-colors"
                >
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 bg-[#E8F5EC] rounded-2xl flex items-center justify-center shrink-0">
              ...
              <div className="px-10 py-8 space-y-5">
                {[
                  ...
                  <div key={field}>
                    ...
                    <input
                      type={type} value={(editing as any)[field]} placeholder={placeholder}
                  ...
                  {[
                    ...
                    <div key={field}>
                      ...
                      <div className="relative">
                        ...
                        <input
                          type="number" value={(editing as any)[field]}
